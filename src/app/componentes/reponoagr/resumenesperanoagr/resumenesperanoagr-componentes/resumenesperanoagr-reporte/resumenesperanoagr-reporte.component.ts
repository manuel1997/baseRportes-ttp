...
@Component({
  selector: 'app-resumenesperanoagr-reporte',
  templateUrl: './resumenesperanoagr-reporte.component.html',
  styleUrls: ['./resumenesperanoagr-reporte.component.css']
})
export class ResumenesperanoagrReporteComponent implements OnInit {
        ...
        for (let index = 0; index < registros.length; index++) {
          ...
          if (index == 0) {
            ...
            this.datos.push({
              ...
              // "rango": campos[7],
              // "acum": campos[8],
              // "esperaacum": this.minuto(campos[9])
              ...
              "rango": campos[8],
              "acum": campos[9],
              "esperaacum": this.minuto(campos[10]),
              "desperaacum": this.minuto(campos[11])
            });
          }
        }
      } else {
    ...
    if (data['data'] == '' || data['data'] == undefined) {
      ...
      if(resultado == 'ok'){
        ...
        setTimeout(() => {
          ...
          tmpElemento.download = 'Resumen_Espera_noagr_' + new Date().getTime() + EXCEL_EXTENSION;
          tmpElemento.click();
        } , 1200);
      } else {
        Swal('Error', this.validarService.validarError(data), 'error');
