...
@Component({
  selector: 'app-resumenesperanoagr-form',
  templateUrl: './resumenesperanoagr-form.component.html',
  styleUrls: ['./resumenesperanoagr-form.component.css']
})
export class ResumenesperanoagrFormComponent implements OnInit {
