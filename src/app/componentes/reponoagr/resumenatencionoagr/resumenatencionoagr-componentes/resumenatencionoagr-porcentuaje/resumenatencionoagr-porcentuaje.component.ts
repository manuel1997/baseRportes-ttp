...
@Component({
  selector: 'app-resumenatencionoagr-porcentuaje',
  templateUrl: './resumenatencionoagr-porcentuaje.component.html',
  styleUrls: ['./resumenatencionoagr-porcentuaje.component.css']
})
export class ResumenatencionoagrPorcentuajeComponent implements OnInit {
