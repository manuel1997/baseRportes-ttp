...
@Component({
  selector: 'app-resumenatencionoagr-graficos',
  templateUrl: './resumenatencionoagr-graficos.component.html',
  styleUrls: ['./resumenatencionoagr-graficos.component.css']
})
export class ResumenatencionoagrGraficosComponent implements OnInit {
