...
@Component({
  selector: 'app-rankingdeatenciones-graficos',
  templateUrl: './rankingdeatenciones-graficos.component.html',
  styleUrls: ['./rankingdeatenciones-graficos.component.css']
})
export class RankingdeatencionesGraficosComponent implements OnInit {
    ...
    if (data['data'] == '' || data['data'] == undefined) {
      ...
      if (this.validarService.validarError(data) == 'ok') {
        ...
        for (let index = 0; index < registros.length; index++) {
          ...
          if (campos[0] != 'TOT') {
            this.dataGrafico.push(campos[2]);
          }
