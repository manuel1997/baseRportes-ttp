...
@Component({
  selector: 'app-rankingdeatenciones-form',
  templateUrl: './rankingdeatenciones-form.component.html',
  styleUrls: ['./rankingdeatenciones-form.component.css']
})
export class RankingdeatencionesFormComponent implements OnInit {
