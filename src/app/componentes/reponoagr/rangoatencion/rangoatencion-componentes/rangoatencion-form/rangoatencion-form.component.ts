...
@Component({
  selector: 'app-rangoatencion-form',
  templateUrl: './rangoatencion-form.component.html',
  styleUrls: ['./rangoatencion-form.component.css']
})
export class RangoatencionFormComponent implements OnInit {
