...
@Component({
  selector: 'app-tendencia-atencion-porcentuaje',
  templateUrl: './tendencia-atencion-porcentuaje.component.html',
  styleUrls: ['./tendencia-atencion-porcentuaje.component.css']
})
export class TendenciaAtencionPorcentuajeComponent implements OnInit {
  ...
  async generarPorcentuaje(){
    ...
    this.rango = "";
    this._api.TendenciaAtencion_noagr.g = 'g';
  ...
  async arreglo_datos() {
    this._api.TendenciaAtencion_noagr.g = 'R';
